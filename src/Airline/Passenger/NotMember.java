/**
 * NotMember.java is an implementation of the MemberPassenger interface which helps 
...
public class NotMember implements MemberPassenger {

	//Default generated serialVersionUID so we can save NotMembers
	private static final long serialVersionUID = -3033687303829024051L;
	...
	public boolean canRegister(Airplane plane) {
		...
		if(differenceNum <= MemberPassenger.NORMAL_REGISTRATION_DAYS) {
			return true;
		}
		else {
			return false;
	...
	public void updateMembership(Passenger passenger) throws CannotUpgradeMembershipException {
		passenger.setMembership(new SilverMember());
	}
